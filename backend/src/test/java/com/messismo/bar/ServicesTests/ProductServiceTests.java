...
public class ProductServiceTests {
    ...
    public void testProductServiceAddProduct() {
        ...
        ProductDTO productDTO1 = ProductDTO.builder().category("Entrada").stock(40).description("Con aderezos").unitPrice(77.00).name("Papas Con Bacon").build();
    ...
    public void testProductServiceAddProduct_WithSameName() {
        ...
        ProductDTO productDTO1 = ProductDTO.builder().name("Milanesa").category("Entrada").description("Milanesa con papas fritas").stock(50).unitPrice(70.00).build();
    ...
    public void testProductServiceAddProduct_WithNullName() {
        ...
        ProductDTO productDTO1 = ProductDTO.builder().name(null).category("Entrada").description("Milanesa con papas fritas").stock(50).unitPrice(70.00).build();
    ...
    public void testProductServiceAddProduct_WithEmptyName() {
        ...
        ProductDTO productDTO1 = ProductDTO.builder().name("").category("Entrada").description("Milanesa con papas fritas").stock(50).unitPrice(70.00).build();
        ResponseEntity<String> response = ResponseEntity.status(HttpStatus.CONFLICT).body("Missing information to create a product");
    ...
    public void testProductServiceAddProduct_WithNullUnitPrice() {
        ...
        ProductDTO productDTO1 = ProductDTO.builder().name("Pollito").category("Entrada").description("Milanesa con papas fritas").stock(50).unitPrice(null).build();
        ResponseEntity<String> response = ResponseEntity.status(HttpStatus.CONFLICT).body("Missing information to create a product");
    ...
    public void testProductServiceAddProduct_WithNullCategory() {
        ...
        ProductDTO productDTO1 = ProductDTO.builder().name("MilanesaTOP").category(null).description("Milanesa con papas fritas").stock(50).unitPrice(70.00).build();
        ResponseEntity<String> response = ResponseEntity.status(HttpStatus.CONFLICT).body("Missing information to create a product");
    ...
    public void testProductServiceAddProduct_WithNullDescription() {
        ...
        ProductDTO productDTO1 = ProductDTO.builder().name("MilanesaTOP").category("Entrada").description(null).stock(50).unitPrice(70.00).build();
        ResponseEntity<String> response = ResponseEntity.status(HttpStatus.CONFLICT).body("Missing information to create a product");
    ...
    public void testProductServiceCannotAddProduct() {
        ...
        ProductDTO productDTO1 = ProductDTO.builder().name("Pizza").category("Entrada").description("Pizza con papas fritas").stock(50).unitPrice(70.00).build();
    ...
    public void testProductServiceFilterByCategory() {
        ...
        Product product1 = Product.builder().productId(1L).name("Milanesa").unitPrice(14.99).category(category1).stock(50).description("Milanesa con papas fritas").build();
        Product product2 = Product.builder().productId(2L).name("Milanesas").unitPrice(44.99).category(category1).stock(25).description("Milanesas con papas fritas2").build();
        Product product3 = Product.builder().productId(3L).name("Pollo").unitPrice(15.99).category(category2).stock(5).description("Pollo con papas fritas").build();
        List<Product> products = new ArrayList<>();
        products.add(product1);
        products.add(product2);
        products.add(product3);
    ...
    public void testProductServiceFilterByMinStockPrice() {
        ...
        Category category1 = Category.builder().categoryId(1L).name("Entrada").build();
        Product product1 = Product.builder().productId(1L).name("Milanesa").unitPrice(14.99).category(category1).stock(15).description("Milanesa con papas fritas").build();
        Product product2 = Product.builder().productId(2L).name("Milanesas").unitPrice(44.99).category(category1).stock(25).description("Milanesas con papas fritas2").build();
        Product product3 = Product.builder().productId(3L).name("Pollo").unitPrice(15.99).category(category1).stock(5).description("Pollo con papas fritas").build();
        List<Product> products = new ArrayList<>();
        products.add(product1);
    ...
    public void testProductServiceFilterProducts() {
        ...
        FilterProductDTO filterProductDTO = FilterProductDTO.builder().productName("Milanesa").categoryName("Entrada").maxStock(30).minStock(0).maxUnitPrice(50.00).minUnitPrice(16.00).build();
        Category category1 = Category.builder().categoryId(1L).name("Entrada").build();
        Product product2 = Product.builder().productId(2L).name("Milanesas").unitPrice(44.99).category(category1).stock(25).description("Milanesas con papas fritas2").build();
        List<Product> response = new ArrayList<>();
        response.add(product2);
    ...
    public void testProductServiceFilterProducts_WithNonExistentCategory() {
        ...
        FilterProductDTO filterProductDTO = FilterProductDTO.builder().productName("Milanesa").categoryName("Plato").maxStock(30).minStock(0).maxUnitPrice(50.00).minUnitPrice(16.00).build();
        Category category1 = Category.builder().categoryId(1L).name("Entrada").build();
