...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> {
            ...
            auth.requestMatchers(PathRequest.toH2Console()).permitAll(); // SOLO SI SE NECESITA LA CONSOLA DE LA H2, ES DECIR, ESTA CON EL PROFILE TEST
...
//                .requestMatchers("/api/v1/validatedEmployee/**").hasAnyRole(ADMIN.name(), MANAGER.name(), VALIDATEDEMPLOYEE.name())
//                .requestMatchers("/api/v1/employee/**").hasAnyRole(ADMIN.name(), MANAGER.name(), VALIDATEDEMPLOYEE.name(), EMPLOYEE.name())
//                .anyRequest()
//                .authenticated()
//                .and()
//                .sessionManagement()
